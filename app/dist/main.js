...
`),ye=me,be=ue,ve=je,ke=$.ZP.div((()=>$.iv`
  ...
  `)),ft=$.ZP.p((e=>$.iv`
    ...
    animation: ${be} 0.5s ease-out;
  `)),gt=e=>{const{show:t,type:i,title:s,description:o}=e;return(0,n.jsxs)(ct,{children:[(0,n.jsx)(a,Object.assign({check:t&&"icon"===i},{children:(0,n.jsx)(ht,{children:(0,n.jsx)(J,{type:"spinner",size:12})})})),(0,n.jsx)(a,Object.assign({check:t&&"fullScreen"===i},{children:(0,n.jsxs)(lt,{children:[(0,n.jsx)(ht,{children:(0,n.jsx)(J,{type:"spinner",size:12})}),(0,n.jsx)(dt,{children:s}),(0,n.jsx)(ft,{children:o})]})}))]})};var xt=i(915),pt=i.n(xt);const mt=(()=>{if(window.require)return console.log("initing nodeJS layer"),pt()(window.require)})(),ut={method:"GET",mode:"cors",headers:{}};var jt=i(160),yt=i.n(jt),bt=function(e,t,i,n){return new(i||(i=Promise))((function(s,o){function r(e){try{c(n.next(e))}catch(e){o(e)}}function a(e){try{c(n.throw(e))}catch(e){o(e)}}function c(e){var t;e.done?s(e.value):(t=e.value,t instanceof i?t:new i((function(e){e(t)}))).then(r,a)}c((n=n.apply(e,t||[])).next())}))};const vt=e=>bt(void 0,void 0,void 0,(function*(){try{console.log(yield mt.sytem.usage());const i=yield fetch(e,ut),n=yield i.blob();if(!(null==n?void 0:n.size))return"";const s=yield(t=n,new Promise(((e,i)=>{new(yt())({file:t,quality:.2,mimeType:"image/jpeg",width:1920,height:1080,convertSize:1/0,loose:!0,redressOrientation:!0,success:i=>{const n=(t.size/1024).toFixed(2),s=(i.size/1024).toFixed(2),o=((t.size-i.size)/t.size*100).toFixed(2)+"%";console.log(`Image compressor: ${n} Kb -> ${s} Kb, ratio: ${o}`),e(i)},error:i})}))),o=new FileReader;o.readAsDataURL(s);const r=yield new Promise((e=>o.onload=()=>e(o.result)));return r||""}catch(e){return console.error(e),""}var t})),kt=e=>bt(void 0,void 0,void 0,(function*(){const t="image_cache",i=localStorage.getItem(t)||"[]",n=JSON.parse(i),s=n.find((t=>t.url===e));if(s)return s.data;const o=yield vt(e);return n.push({url:e,data:o}),localStorage.setItem(t,JSON.stringify(n)),o}));var wt=function(e,t,i,n){return new(i||(i=Promise))((function(s,o){function r(e){try{c(n.next(e))}catch(e){o(e)}}function a(e){try{c(n.throw(e))}catch(e){o(e)}}function c(e){var t;e.done?s(e.value):(t=e.value,t instanceof i?t:new i((function(e){e(t)}))).then(r,a)}c((n=n.apply(e,t||[])).next())}))};const zt=e=>wt(void 0,void 0,void 0,(function*(){const t=e.split(" ").join("+");return(yield tt.fetchHTML(`http://www.bing.com/images/search?q=${t}`)).replace(/&quot;/g,'"').match(/"murl":".*?"/gm).join(",").match(/"https:\/\/.*?"/gm).map((e=>e.replace(/\"/g,"")))})),St=$.ZP.div((({theme:e})=>$.iv`
    width: 100%;
    padding: ${e.size(4)};
    height: ${e.size(100)};
    ...
    justify-content: center;
    align-items: center;
  `)),Ot=$.ZP.img((({theme:e})=>$.iv`
    max-width: 100%;
    max-height: 100%;
    border-radius: ${e.radius.large};
    box-shadow: ${e.shadow.high};
  `));const $t=e=>{const{active:t,sufix:i,value:s,onChange:o,onClose:r}=e,c=R(),{option:l,setOption:h,loading:d,setLoading:f}=V(),[g,x]=(0,A.useState)(""),[p,m]=(0,A.useState)([]),[u,j]=(0,A.useState)("");return(0,A.useEffect)((()=>{if(t){const e=l<p.length;c("ArrowLeft",(()=>l&&h(l-1))),c("ArrowRight",(()=>e&&h(l+1))),c("ButtonA",r)}}),[c]),(0,A.useEffect)((()=>{var e,n,o,r;(e=void 0,n=void 0,o=void 0,r=function*(){if(f(!0),t&&s.length>=3&&s!==g){const t=yield(e=s+i,wt(void 0,void 0,void 0,(function*(){const t=`${e.toLowerCase()}`;return yield zt(t)})));m(t),x(s)}var e},new(o||(o=Promise))((function(t,i){function s(e){try{c(r.next(e))}catch(e){i(e)}}function a(e){try{c(r.throw(e))}catch(e){i(e)}}function c(e){var i;e.done?t(e.value):(i=e.value,i instanceof o?i:new o((function(e){e(i)}))).then(s,a)}c((r=r.apply(e,n||[])).next())}))).catch(console.error).finally((()=>f(!1)))}),[t,s]),(0,A.useEffect)((()=>{f(!0),o&&o(p[l]),vt(p[l]).then((e=>{f(!1),j(e)}))}),[l,p.length]),(0,n.jsxs)(St,{children:[(0,n.jsx)(a,Object.assign({check:!d},{children:(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(a,{check:t,true:(0,n.jsx)(J,{type:"arrow-left",size:14})}),(0,n.jsx)(Ot,{src:u}),(0,n.jsx)(a,{check:t,true:(0,n.jsx)(J,{type:"arrow-right",size:14})})]})})),(0,n.jsx)(gt,{type:"icon",show:d})]})},Pt=$.ZP.div((({theme:e,active:t,focus:i})=>$.iv`
      margin: 0 auto;
      padding: ${e.size(4)};
  ...
  `)),Lt=e=>{const{active:t,value:i,onChange:s}=e;return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(Nt,{ref:e=>t?null==e?void 0:e.focus():null==e?void 0:e.blur(),value:i,onChange:e=>s(e.target.value)}),(0,n.jsx)(a,Object.assign({check:t},{children:(0,n.jsx)(Zt,{value:i,onChange:s,onEnterPress:()=>{},onEscPress:()=>{}})}))]})},Et=$.ZP.div((()=>$.iv``)),Rt=e=>{const{type:t}=e;return(0,n.jsx)(It,Object.assign({},e,{children:(0,n.jsxs)(Et,{children:[(0,n.jsx)(a,{check:"text"===t,true:(0,n.jsx)(Lt,Object.assign({},e))}),(0,n.jsx)(a,{check:"img"===t,true:(0,n.jsx)($t,Object.assign({},e))}),(0,n.jsx)(a,{check:"file"===t,true:(0,n.jsx)(at,Object.assign({},e))}),(0,n.jsx)(a,{check:"color"===t,true:(0,n.jsx)(et,Object.assign({},e))})]})}))},Dt=$.ZP.div((()=>$.iv`
    width: 100%;
    height: 100%;
    overflow-y: auto;
    scroll-behavior: smooth;
