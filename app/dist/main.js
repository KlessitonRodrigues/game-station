(()=>{var e,t,i,n={793:(e,t,i)=>{"use strict";var n=i(893),r=i(745),o=i(655),a=i(250),s=i(788);const c=s.ZP.div((({gradient:e,img:t,zIndex:i})=>s.iv`
    z-index: ${i||-1};
    position: fixed;
    top: 0;
    left: 0;
  ...
  `)),O="#880e4f",P="#c51162",S="#8e24aa",k="#aa00ff",A="#6200ea",Z="#0091ea",C="#00b8d4",B="#7cb342",U="#64dd17",D="#e0e0e0",E="#bdbdbd",I="#9e9e9e",L="#757575",M="#616161",R="#424242",W="#141414",T={size:e=>.2*e+"rem",colors:{main:"#039be5",mainBg:"#0C66E4",bg1:D+"55",bg2:D+"33",bg3:D+"22",bg4:D+"11",text1:"#fafafa",text2:"#eeeeee",text3:D,text4:E,gray:E,yellow:"#B38600",red:"#AE2A19",blue:"#388BFF",green:B,white:D,black:W},fontSize:{body:"1rem",small:"0.95rem",verySmall:"0.8rem",label:"0.9rem",h1:"1.6rem",h2:"1.4rem",h3:"1.2rem",h4:"1.1rem",h5:"1.075rem",h6:"1.05rem"},shadow:{low:"1px 1px 2px 0 #0004",medium:"1px 1px 2px 0 #0009",high:"1px 2px 2px 0 #0007",mediumGray:"1px 1px 4px 1px #777a",lowRight:"3px 0 4px 0px #0002",mediumLeft:"-4px 0 4px 0px #0006"},radius:{verySmall:"0.2rem",small:"0.3rem",medium:"0.4rem",large:"0.5rem",full:"50%"},devices:{mobileS:"(max-width: 320px)",mobileM:"(max-width: 425px)",mobileL:"(max-width: 480px)",tablet:"(max-width: 768px)",laptopS:"(max-width: 900px)",laptopM:"(max-width: 1024px)",laptopL:"(max-width: 1280px)",desktopS:"(max-width: 1440px)",desktopM:"(max-width: 1980px)",desktopL:"(max-width: 2560px)"}},F=(Object.assign(Object.assign({},T),{colors:Object.assign(Object.assign({},T.colors),{bg1:W,bg2:R+"44",bg3:M+"44",bg4:L+"44",text1:D,text2:E,text3:I,text4:M,gray:L,white:D})}),{indigo:`linear-gradient(150deg, #2962ff, ${W} 80%)`,blue:`linear-gradient(150deg, ${Z}, ${W} 80%)`,green:`linear-gradient(150deg, ${U}, ${W} 80%)`,deepPurple:`linear-gradient(150deg, ${A}, ${W} 80%)`,purple:`linear-gradient(150deg, ${k}, ${W} 80%)`,pink:`linear-gradient(150deg, ${P}, ${W} 80%)`,red:`linear-gradient(150deg, #d32f2f, ${W} 80%)`,blueAndPurple:`linear-gradient(150deg, ${C}, ${S} 70%)`,blueAndPink:`linear-gradient(150deg, ${C}, ${P} 80%)`,greenAndPink:`linear-gradient(150deg, ${U}, ${O} 80%)`,blueAndBrown:`linear-gradient(150deg, ${Z}, #5d4037 75%)`,purpleAndGreen:`linear-gradient(150deg, ${A}, ${B} 80%)`});var G=i(155),_=i(352);const H={games:(0,n.jsx)(_.gdw,{}),apps:(0,n.jsx)(_.v$D,{}),music:(0,n.jsx)(_.JUP,{}),midia:(0,n.jsx)(_.SD9,{}),web:(0,n.jsx)(_.lct,{}),news:(0,n.jsx)(_.lBz,{}),theme:(0,n.jsx)(_.zCJ,{}),settings:(0,n.jsx)(_.NY,{}),user:(0,n.jsx)(_.sFD,{}),battery:(0,n.jsx)(_.e8c,{}),gamepad:(0,n.jsx)(G.uWr,{}),search:(0,n.jsx)(_.Qcu,{}),folder:(0,n.jsx)(_.G2V,{}),file:(0,n.jsx)(_.UfY,{}),image:(0,n.jsx)(_.RXd,{}),"arrow-left":(0,n.jsx)(_.jW7,{}),"arrow-right":(0,n.jsx)(_.jfD,{}),usb:(0,n.jsx)(_.rAw,{}),controls:(0,n.jsx)(G.uWr,{}),edit:(0,n.jsx)(_.ISo,{}),spinner:(0,n.jsx)(_.H4p,{})},N=s.ZP.span((({theme:e,size:t})=>s.iv`
    display: inline-flex;
...
`),xe=fe,ve=me,be=pe,je=s.ZP.div((()=>s.iv`
  ...
  `)),De=s.ZP.div((({theme:e})=>s.iv`
    ...
    color: ${e.colors.text3};
  `)),Ee=e=>{const t=(0,h.useMemo)((()=>{var t;return null===(t=e.buttons)||void 0===t?void 0:t.map((e=>(0,n.jsxs)(Ue,{children:[(0,n.jsx)(Ce,{content:e.content}),(0,n.jsx)(De,{children:e.label})]})))}),[]);return(0,n.jsx)(Be,{children:t})},Ie=s.ZP.div((()=>s.iv`
    width: 100%;
    height: 100%;
    display: flex;
  ...
  `)),He=e=>{const{gameList:t,gameIndex:i,onChangeGame:r,onStartGame:o}=e,a=Q(),s=(0,h.useMemo)((()=>t[i]),[i,t]);return(0,h.useEffect)((()=>{a("ArrowLeft",(()=>r(i-1))),a("ArrowRight",(()=>r(i+1))),a("ButtonStart",(()=>o(i)))}),[a]),(0,n.jsxs)(Ie,{children:[(0,n.jsxs)(Le,{children:[(0,n.jsx)(Me,Object.assign({img:null==s?void 0:s.cover},{children:null==s?void 0:s.name})),(0,n.jsxs)(Re,{children:[(0,n.jsxs)(We,{children:[(0,n.jsx)(Te,{children:null==s?void 0:s.name}),(0,n.jsx)(Fe,{children:null==s?void 0:s.publisher})]}),(0,n.jsx)(Ge,{children:t.map((e=>(0,n.jsx)(_e,Object.assign({img:e.cover,focus:i},{children:e.name}),e.name)))})]})]}),(0,n.jsx)(Ee,{buttons:[{type:"rounded",content:"A",label:"Details"},{type:"rounded",content:"Y",label:"Add Game"},{type:"rounded",content:"V",label:"Grid View"}]})]})},Ne=s.ZP.div((()=>s.iv`
    ...
    overflow: hidden;
  `)),Ye=()=>{const{focus:e,loading:t,setUI:i}=ee(),[r,o]=b(),[a,s]=(0,h.useState)([]);return(0,h.useEffect)((()=>{const e=f.games.read();i("loading",!0),(e=>ke(void 0,void 0,void 0,(function*(){for(const t of e)try{t.background=yield Ze(t.background),t.cover=yield Ze(t.cover)}catch(e){continue}return e})))(e).then(s).finally((()=>i("loading",!1)))}),[]),(0,h.useEffect)((()=>{var t;const i=null===(t=a[e])||void 0===t?void 0:t.background;o(Object.assign(Object.assign({},r),{imgBg:i}))}),[e,a]),(0,n.jsxs)(Ne,{children:[(0,n.jsx)(He,{gameList:a,gameIndex:e,onChangeGame:e=>e<a.length&&i("focus",e),onStartGame:()=>{}}),t&&(0,n.jsx)(ze,{})]})},Xe=s.ZP.div((({theme:e})=>s.iv`
    display: flex;
    flex-wrap: wrap;
    gap: ${e.size(2)};
    width: 100%;
  `)),qe=s.ZP.div((({theme:e,bg:t,selected:i})=>s.iv`
    width: ${e.size(16)};
    height: ${e.size(16)};
  ...
  `)),Je=Object.keys(F),Ve=e=>{const{active:t,value:i,onChange:r}=e,o=Q(),{option:a,setUI:s}=ee();return(0,h.useEffect)((()=>{t&&(o("ArrowLeft",(()=>s("option",a-1))),o("ArrowRight",(()=>a<11&&s("option",a+1))),o("ButtonA",(()=>r(Je[a]))))}),[o]),(0,n.jsx)(Xe,{children:Object.values(F).map(((e,t)=>(0,n.jsx)(qe,{selected:a===t,bg:e},e)))})},Ke=(()=>{const e=window.require;return window.require=null,{isActive:!!e,resolvePath:t=>{try{return e("path").resolve(t)}catch(e){return console.error(e),""}},fetchHTML:t=>new Promise(((i,n)=>{try{e("http").get(t,(e=>{let t="";e.on("data",(e=>t+=e)),e.on("end",(()=>i(t)))}))}catch(e){n(e)}})),exec:t=>{try{return e("child_process").execSync(t).toString()}catch(e){return console.log(e),""}},listDir:t=>{try{const i=e("fs"),n=e("path");return i.readdirSync(n.resolve(t)).filter((e=>!e.startsWith(".")))}catch(e){return console.error(e),[]}}}})(),Qe=s.ZP.div((({theme:e})=>s.iv`
    width: 100%;
  `)),et=s.ZP.div((({theme:e})=>s.iv`
    padding: ${e.size(1)} 0;
    font-size: ${e.fontSize.small};
  `)),tt=s.ZP.div((({theme:e})=>s.iv`
    width: 100%;
  `)),it=s.ZP.div((({theme:e,active:t})=>s.iv`
    width: 100%;
    display: flex;
    align-items: center;
    padding: ${e.size(.5)} 0;
  ...
  `)),rt=e=>{const{active:t,onChange:i}=e,r=Q(),{focus:o,setUI:a}=ee(),[s,c]=(0,h.useState)("/"),[l,d]=(0,h.useState)([]);(0,h.useEffect)((()=>{t&&(r("ArrowUp",(()=>a("focus",o-1))),r("ArrowDown",(()=>a("focus",o+1))),r("ArrowRight",(()=>{c(Ke.resolvePath(s+"/"+l[o])),a("focus",0)})),r("ArrowLeft",(()=>{c(Ke.resolvePath(s+"/..")),a("focus",0)})),r("ButtonA",(()=>i(s+"/"+l[o]))))}),[r]),(0,h.useEffect)((()=>{const e=Ke.resolvePath(s),t=Ke.listDir(e);d(t)}),[s]);const u=(0,h.useMemo)((()=>l.map(((e,t)=>{const{isFile:i,isExe:r}=(e=>({isFile:e.includes("."),isExe:e.includes(".exe")}))(e);return(0,n.jsxs)(it,Object.assign({active:o===t},{children:[(0,n.jsx)(Y,{type:i?"file":"folder"}),(0,n.jsx)(nt,{children:e})]}),e+t)}))),[l,o]);return(0,n.jsxs)(Qe,{children:[(0,n.jsx)(et,{children:s}),(0,n.jsx)(tt,{children:u})]})};var ot=function(e,t,i,n){return new(i||(i=Promise))((function(r,o){function a(e){try{c(n.next(e))}catch(e){o(e)}}function s(e){try{c(n.throw(e))}catch(e){o(e)}}function c(e){var t;e.done?r(e.value):(t=e.value,t instanceof i?t:new i((function(e){e(t)}))).then(a,s)}c((n=n.apply(e,t||[])).next())}))};const at=e=>ot(void 0,void 0,void 0,(function*(){const t=e.split(" ").join("+");return(yield Ke.fetchHTML(`http://www.bing.com/images/search?q=${t}`)).replace(/&quot;/g,'"').match(/"murl":".*?"/gm).join(",").match(/"https:\/\/.*?"/gm).map((e=>e.replace(/\"/g,"")))})),st=s.ZP.div((({theme:e})=>s.iv`
    width: ${e.size(200)};
    ...
    display: flex;
    justify-content: center;
  `)),ct=s.ZP.img((({theme:e})=>s.iv`
    max-width: 100%;
    max-height: 100%;
    border-radius: ${e.radius.large};
    box-shadow: ${e.shadow.high};
  `));const lt=e=>{const{active:t,value:i,onChange:r}=e,o=Q(),{option:a,setUI:s}=ee(),[c,l]=(0,h.useState)(""),[d,u]=(0,h.useState)([]),[g,f]=(0,h.useState)("");return(0,h.useEffect)((()=>{t&&(o("ArrowLeft",(()=>s("option",a-1))),o("ArrowRight",(()=>{a<d.length&&s("option",a+1)})))}),[o]),(0,h.useEffect)((()=>{var e,n,r,o;t&&i.length>=3&&i!==c&&(e=void 0,n=void 0,r=void 0,o=function*(){const e=yield(t=i,ot(void 0,void 0,void 0,(function*(){const e=`${t.toLowerCase()}`;return yield at(e)})));var t;u(e),l(i)},new(r||(r=Promise))((function(t,i){function a(e){try{c(o.next(e))}catch(e){i(e)}}function s(e){try{c(o.throw(e))}catch(e){i(e)}}function c(e){var i;e.done?t(e.value):(i=e.value,i instanceof r?i:new r((function(e){e(i)}))).then(a,s)}c((o=o.apply(e,n||[])).next())}))).catch(console.error)}),[t,i]),(0,h.useEffect)((()=>{r&&r(d[a]),Ae(d[a]).then(f)}),[a,d.length]),(0,n.jsx)(st,{children:(0,n.jsx)(ct,{src:g})})},dt=s.ZP.input((({theme:e})=>s.iv`
    width: 100%;
    ...
    text-transform: capitalize;
  `)),ht=e=>{const{value:t,onChange:i}=e;return(0,n.jsx)(dt,{autoFocus:!0,value:t,onChange:e=>i(e.target.value)})},ut=s.ZP.div((()=>s.iv``)),gt=s.ZP.div((({theme:e})=>s.iv`
    width: 100%;
    height: 100%;
  ...
  `)),ft=s.ZP.div((()=>s.iv`
    ...
    transition: all 0.1s;
  `)),mt=s.ZP.h3((({theme:e})=>s.iv`
    font-size: ${e.fontSize.h3};
    font-weight: bold;
  `)),pt=e=>{const{type:t,active:i,title:r}=e;return(0,n.jsx)(ge,Object.assign({check:i},{children:(0,n.jsx)(ut,{children:(0,n.jsx)(ft,{children:(0,n.jsxs)(gt,{children:[(0,n.jsx)(mt,{children:r}),(0,n.jsx)(ge,{check:"text"===t,true:(0,n.jsx)(ht,Object.assign({},e))}),(0,n.jsx)(ge,{check:"img"===t,true:(0,n.jsx)(lt,Object.assign({},e))}),(0,n.jsx)(ge,{check:"file"===t,true:(0,n.jsx)(rt,Object.assign({},e))}),(0,n.jsx)(ge,{check:"color"===t,true:(0,n.jsx)(Ve,Object.assign({},e))})]})})})}))},xt=s.ZP.div((({theme:e,active:t})=>s.iv`
    width: 75%;
    margin: 0 auto;
    padding: ${e.size(4)};
    ...
    `}
  `)),vt=s.ZP.div((({theme:e})=>s.iv`
    display: flex;
    align-items: center;
    gap: ${e.size(4)};
  `)),bt=s.ZP.div((({theme:e})=>s.iv`
    font-size: ${e.fontSize.h4};
    font-weight: bold;
  `)),jt=s.ZP.div((()=>s.iv`
    transition: 0.3s;
  ...
  `)),yt=e=>{const{active:t,title:i,value:r,children:o}=e;return(0,n.jsxs)(xt,Object.assign({active:t},{children:[(0,n.jsxs)(vt,{children:[(0,n.jsx)(bt,{children:i}),(0,n.jsx)(jt,{children:null==r?void 0:r.substring(0,60)}),(0,n.jsx)(Y,{type:"edit",size:6})]}),(0,n.jsx)(wt,{children:o})]}))},$t=s.ZP.div((()=>s.iv`
    width: 100%;
    height: 100%;
  `)),zt=s.ZP.h2((({theme:e})=>s.iv`
    width: fit-content;
    margin: 0 auto;
    text-align: center;
    font-size: ${e.fontSize.h2};
