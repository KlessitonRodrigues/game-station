(()=>{var e,t,i,n={504:(e,t,i)=>{"use strict";var n=i(893),r=i(745),o=i(655),a=i(250),s=i(788);const c=s.ZP.div((({gradient:e,img:t,zIndex:i})=>s.iv`
    z-index: ${i||-1};
    position: fixed;
    top: 0;
    left: 0;
  ...
  `)),O="#880e4f",P="#c51162",k="#8e24aa",S="#aa00ff",A="#6200ea",C="#0091ea",B="#00b8d4",U="#7cb342",Z="#64dd17",D="#e0e0e0",E="#bdbdbd",I="#9e9e9e",L="#757575",M="#616161",R="#424242",T="#141414",W={size:e=>.2*e+"rem",colors:{main:"#039be5",mainBg:"#0C66E4",bg1:D+"55",bg2:D+"33",bg3:D+"22",bg4:D+"11",text1:"#fafafa",text2:"#eeeeee",text3:D,text4:E,gray:E,yellow:"#B38600",red:"#AE2A19",blue:"#388BFF",green:U,white:D,black:T},fontSize:{body:"1rem",small:"0.95rem",verySmall:"0.8rem",label:"0.9rem",h1:"1.6rem",h2:"1.4rem",h3:"1.2rem",h4:"1.1rem",h5:"1.075rem",h6:"1.05rem"},shadow:{low:"1px 1px 2px 0 #0004",medium:"1px 1px 2px 0 #0009",high:"1px 2px 2px 0 #0007",mediumGray:"1px 1px 4px 1px #777a",lowRight:"3px 0 4px 0px #0002",mediumLeft:"-4px 0 4px 0px #0006"},radius:{verySmall:"0.2rem",small:"0.3rem",medium:"0.4rem",large:"0.5rem",full:"50%"},devices:{mobileS:"(max-width: 320px)",mobileM:"(max-width: 425px)",mobileL:"(max-width: 480px)",tablet:"(max-width: 768px)",laptopS:"(max-width: 900px)",laptopM:"(max-width: 1024px)",laptopL:"(max-width: 1280px)",desktopS:"(max-width: 1440px)",desktopM:"(max-width: 1980px)",desktopL:"(max-width: 2560px)"}},F=(Object.assign(Object.assign({},W),{colors:Object.assign(Object.assign({},W.colors),{bg1:T,bg2:R+"44",bg3:M+"44",bg4:L+"44",text1:D,text2:E,text3:I,text4:M,gray:L,white:D})}),{indigo:`linear-gradient(150deg, #2962ff, ${T} 80%)`,blue:`linear-gradient(150deg, ${C}, ${T} 80%)`,green:`linear-gradient(150deg, ${Z}, ${T} 80%)`,deepPurple:`linear-gradient(150deg, ${A}, ${T} 80%)`,purple:`linear-gradient(150deg, ${S}, ${T} 80%)`,pink:`linear-gradient(150deg, ${P}, ${T} 80%)`,red:`linear-gradient(150deg, #d32f2f, ${T} 80%)`,blueAndPurple:`linear-gradient(150deg, ${B}, ${k} 70%)`,blueAndPink:`linear-gradient(150deg, ${B}, ${P} 80%)`,greenAndPink:`linear-gradient(150deg, ${Z}, ${O} 80%)`,blueAndBrown:`linear-gradient(150deg, ${C}, #5d4037 75%)`,purpleAndGreen:`linear-gradient(150deg, ${A}, ${U} 80%)`});var G=i(155),_=i(352);const H={games:(0,n.jsx)(_.gdw,{}),apps:(0,n.jsx)(_.v$D,{}),music:(0,n.jsx)(_.JUP,{}),midia:(0,n.jsx)(_.SD9,{}),web:(0,n.jsx)(_.lct,{}),news:(0,n.jsx)(_.lBz,{}),theme:(0,n.jsx)(_.zCJ,{}),settings:(0,n.jsx)(_.NY,{}),user:(0,n.jsx)(_.sFD,{}),battery:(0,n.jsx)(_.e8c,{}),gamepad:(0,n.jsx)(G.uWr,{}),search:(0,n.jsx)(_.Qcu,{}),folder:(0,n.jsx)(_.G2V,{}),file:(0,n.jsx)(_.UfY,{}),image:(0,n.jsx)(_.RXd,{}),"arrow-left":(0,n.jsx)(_.jW7,{}),"arrow-right":(0,n.jsx)(_.jfD,{}),usb:(0,n.jsx)(_.rAw,{}),controls:(0,n.jsx)(G.uWr,{}),edit:(0,n.jsx)(_.ISo,{})},N=s.ZP.span((({theme:e,size:t})=>s.iv`
    display: inline-flex;
    font-size: ${e.size(t||8)};
  `)),Y=e=>{const{type:t,size:i,style:r}=e;return(0,n.jsx)(N,Object.assign({size:i,style:r},{children:H[t]}))},X={axis0Pos:"LeftStickRight",axis0Neg:"LeftStickLeft",axis1Pos:"LeftStickDown",axis1Neg:"LeftStickUp",axis2Pos:"RightStickRight",axis2Neg:"RightStickLeft",axis3Pos:"RightStickDown",axis3Neg:"RightStickUp",button0:"ButtonA",button1:"ButtonB",button2:"ButtonX",button3:"ButtonY",button4:"ButtonLeft",button5:"ButtonRight",button6:"TriggerLeft",button7:"TriggerRight",button8:"ButtonSelect",button9:"ButtonStart",button10:"LeftStick",button11:"RightStick",button12:"ArrowUp",button13:"ArrowDown",button14:"ArrowLeft",button15:"ArrowRight",button16:"ButtonHome"},q=[],J=e=>{console.log("Disconnected",e.gamepad.id),q.forEach((e=>clearInterval(e)))},V=(0,h.createContext)((()=>{})),K=e=>{const[t,i]=(0,h.useState)([]),r=(0,h.useCallback)(((e,i)=>{1===t.length&&t.includes(e)&&i&&i()}),[t]);return(0,h.useEffect)((()=>{window.addEventListener("gamepadconnected",(e=>((e,t)=>{console.log("Connected",e.gamepad.id),q.push(((e,t)=>{const i={time:0,buttons:[""]};return setInterval((()=>{const{timestamp:n,axes:r,buttons:o}=navigator.getGamepads()[e],a=[];if(n===i.time)return i.time=n;i.time=n,r.forEach(((e,t)=>{if(1!==e&&-1!==e)return!1;const i=`axis${t}${e>0?"Pos":"Neg"}`;X[i]&&a.push(X[i])})),o.forEach(((e,t)=>{if(0===e.value)return!1;const i=`button${t}`;X[i]&&a.push(X[i])})),i.buttons.toString()!==a.toString()&&(i.buttons=a,t&&t(a))}),33.33)})(e.gamepad.index,t))})(e,i))),window.addEventListener("gamepaddisconnected",J)}),[]),(0,n.jsx)(V.Provider,Object.assign({value:r},{children:e.children}))},Q=()=>(0,h.useContext)(V),ee=()=>{const[e,t]=(0,h.useState)(!1),[i,n]=(0,h.useState)(0),[r,o]=(0,h.useState)(0),a=(0,h.useCallback)(((i,r)=>{"active"===i&&"boolean"==typeof r&&t(r),"focus"===i&&"number"==typeof r&&!e&&r>=0&&n(r),"option"===i&&"number"==typeof r&&r>=0&&o(r)}),[e,i,r]);return{focus:i,active:e,option:r,setUI:a}},te=[{name:"games",route:"games/list/bar"},{name:"apps",route:"apps"},{name:"music",route:"music"},{name:"midia",route:"midia"},{name:"web",route:"web"},{name:"theme",route:"theme"},{name:"controls",route:"controls"},{name:"settings",route:"settings"}],ie=s.ZP.div((({theme:e})=>s.iv`
    width: 100%;
  ...
  `)),de=s.ZP.div((({theme:e})=>s.iv`
    ...
    height: 100%;
    padding: ${e.size(4)};
  `)),he=e=>(0,n.jsx)(le,{children:(0,n.jsx)(de,{children:e.children})}),ue=()=>(0,n.jsx)(he,{}),ge=e=>e.check?e.true||e.children:e.false,fe={method:"GET",mode:"cors"};var me=i(160),pe=i.n(me),xe=function(e,t,i,n){return new(i||(i=Promise))((function(r,o){function a(e){try{c(n.next(e))}catch(e){o(e)}}function s(e){try{c(n.throw(e))}catch(e){o(e)}}function c(e){var t;e.done?r(e.value):(t=e.value,t instanceof i?t:new i((function(e){e(t)}))).then(a,s)}c((n=n.apply(e,t||[])).next())}))};const ve=e=>new Promise(((t,i)=>{fetch(e,fe).then((e=>xe(void 0,void 0,void 0,(function*(){const t=yield e.blob(),i=yield(n=t,new Promise(((e,t)=>{new(pe())({file:n,quality:.1,mimeType:"image/jpeg",width:1920,height:1080,convertSize:1/0,loose:!0,redressOrientation:!0,success:t=>{const i=(n.size/1024).toFixed(2),r=(t.size/1024).toFixed(2),o=((n.size-t.size)/n.size*100).toFixed(2)+"%";console.log(`Image compressor: ${i} Kb -> ${r} Kb, ratio: ${o}`),e(t)},error:e=>{console.error(e),t(e)}})})));var n;const r=new FileReader;return r.readAsDataURL(i),yield new Promise((e=>r.onload=()=>e(r.result)))})))).then(t).catch(i)})),be=e=>xe(void 0,void 0,void 0,(function*(){const t="image_cache",i=localStorage.getItem(t)||"[]",n=JSON.parse(i),r=n.find((t=>t.url===e));if(r)return r.data;const o=yield ve(e);return n.push({url:e,data:o}),localStorage.setItem(t,JSON.stringify(n)),o})),je=e=>{const{content:t}=e;return(0,n.jsx)("div",Object.assign({style:{display:"block",width:"1.8rem"}},{children:(0,n.jsxs)("svg",Object.assign({width:"100%",height:"100%",viewBox:"0 0 64 64",xmlns:"http://www.w3.org/2000/svg"},{children:[(0,n.jsx)("circle",{id:"Oval",fill:"none",cx:"31",cy:"31",r:"27.841",style:{strokeWidth:"4px",stroke:"#999"},transform:"matrix(0.910153, 0, 0, 0.89304, 3.448403, 3.713665)"}),(0,n.jsx)("text",Object.assign({style:{fill:"#DDD",fontFamily:"FreeSans",fontSize:"32.4528px",fontWeight:"bold",whiteSpace:"pre"},transform:"matrix(1.478571, 0, 0, 1.232558, -10.114382, -9.312138",x:"19.5",y:"44"},{children:t}))]}))}))},we=s.F4`
...
`,$e=(s.F4`
   from {opacity: 0}
   to {opacity: 1}
`,we),ze=ye,Oe=s.ZP.div((({theme:e})=>s.iv`
    position: fixed;
    bottom: ${e.size(6)};
    left: 50%;
    display: flex;
    ...
    translate: -50%;
  `)),Pe=s.ZP.div((({theme:e})=>s.iv`
    display: flex;
    align-items: center;
    gap: ${e.size(1)};
  `)),ke=s.ZP.div((({theme:e})=>s.iv`
    font-size: ${e.fontSize.label};
    padding-bottom: ${e.size(.75)};
    color: ${e.colors.text3};
  `)),Se=e=>{const t=(0,h.useMemo)((()=>{var t;return null===(t=e.buttons)||void 0===t?void 0:t.map((e=>(0,n.jsxs)(Pe,{children:[(0,n.jsx)(je,{content:e.content}),(0,n.jsx)(ke,{children:e.label})]})))}),[]);return(0,n.jsx)(Oe,{children:t})},Ae=s.ZP.div((()=>s.iv`
    width: 100%;
    height: 100%;
    display: flex;
    align-items: flex-end;
  `)),Ce=s.ZP.div((({theme:e})=>s.iv`
    width: 100%;
    display: flex;
    gap: ${e.size(8)};
    height: ${e.size(120)};
    margin-bottom: ${e.size(20)};
  `)),Be=s.ZP.div((({theme:e,img:t})=>s.iv`
    height: 100%;
    width: ${e.size(90)};
    min-width: ${e.size(90)};
    max-width: ${e.size(90)};
  ...
  `)),Ie=s.ZP.div((()=>s.iv`
    ...
    display: flex;
    overflow: hidden;
  `)),Le=s.ZP.div((({theme:e,focus:t,img:i})=>s.iv`
    height: 100%;
    width: ${e.size(50)};
    max-width: ${e.size(50)};
  ...
  `)),Me=e=>{const{gameList:t,gameIndex:i,onChangeGame:r,onStartGame:o}=e,a=Q(),s=(0,h.useMemo)((()=>t[i]),[i,t]);return(0,h.useEffect)((()=>{a("ArrowLeft",(()=>r(i-1))),a("ArrowRight",(()=>r(i+1))),a("ButtonStart",(()=>o(i)))}),[a]),(0,n.jsxs)(Ae,{children:[(0,n.jsxs)(Ce,{children:[(0,n.jsx)(Be,Object.assign({img:null==s?void 0:s.cover},{children:null==s?void 0:s.name})),(0,n.jsxs)(Ue,{children:[(0,n.jsxs)(Ze,{children:[(0,n.jsx)(De,{children:null==s?void 0:s.name}),(0,n.jsx)(Ee,{children:null==s?void 0:s.publisher})]}),(0,n.jsx)(Ie,{children:t.map((e=>(0,n.jsx)(Le,Object.assign({img:e.cover,focus:i},{children:e.name}),e.name)))})]})]}),(0,n.jsx)(Se,{buttons:[{type:"rounded",content:"A",label:"Details"},{type:"rounded",content:"Y",label:"Add Game"},{type:"rounded",content:"V",label:"Grid View"}]})]})},Re=s.ZP.div((()=>s.iv`
    width: 100%;
    height: 100%;
    display: flex;
    align-items: flex-end;
    overflow: hidden;
  `)),Te=()=>{const{focus:e,setUI:t}=ee(),[i,r]=b(),[o,a]=(0,h.useState)([]);return(0,h.useEffect)((()=>{var e;(e=f.games.read(),xe(void 0,void 0,void 0,(function*(){for(const t of e)try{t.background=yield be(t.background),t.cover=yield be(t.cover)}catch(e){console.error(e);continue}return e}))).then(a)}),[]),(0,h.useEffect)((()=>{var t;const n=null===(t=o[e])||void 0===t?void 0:t.background;r(Object.assign(Object.assign({},i),{imgBg:n}))}),[e,o]),(0,n.jsx)(Re,{children:(0,n.jsx)(Me,{gameList:o,gameIndex:e,onChangeGame:e=>e<o.length&&t("focus",e),onStartGame:()=>{}})})},We=s.ZP.div((({theme:e})=>s.iv`
    display: flex;
    flex-wrap: wrap;
    gap: ${e.size(2)};
    width: 100%;
  `)),Fe=s.ZP.div((({theme:e,bg:t,selected:i})=>s.iv`
    width: ${e.size(16)};
    height: ${e.size(16)};
  ...
  `)),Ge=Object.keys(F),_e=e=>{const{active:t,value:i,onChange:r}=e,o=Q(),{option:a,setUI:s}=ee();return(0,h.useEffect)((()=>{t&&(o("ArrowLeft",(()=>s("option",a-1))),o("ArrowRight",(()=>a<11&&s("option",a+1))),o("ButtonA",(()=>r(Ge[a]))))}),[o]),(0,n.jsx)(We,{children:Object.values(F).map(((e,t)=>(0,n.jsx)(Fe,{selected:a===t,bg:e},e)))})},He=(()=>{const e=window.require;return window.require=null,{isActive:!!e,resolvePath:t=>{try{return e("path").resolve(t)}catch(e){return console.error(e),""}},fetchHTML:t=>new Promise(((i,n)=>{try{e("http").get(t,(e=>{let t="";e.on("data",(e=>t+=e)),e.on("end",(()=>i(t)))}))}catch(e){n(e)}})),exec:t=>{try{return e("child_process").execSync(t).toString()}catch(e){return console.log(e),""}},listDir:t=>{try{const i=e("fs"),n=e("path");return i.readdirSync(n.resolve(t)).filter((e=>!e.startsWith(".")))}catch(e){return console.error(e),[]}}}})(),Ne=s.ZP.div((({theme:e})=>s.iv`
    width: 100%;
  `)),Ye=s.ZP.div((({theme:e})=>s.iv`
    padding: ${e.size(1)} 0;
    font-size: ${e.fontSize.small};
  `)),Xe=s.ZP.div((({theme:e})=>s.iv`
    width: 100%;
  `)),qe=s.ZP.div((({theme:e,active:t})=>s.iv`
    width: 100%;
    display: flex;
    align-items: center;
    padding: ${e.size(.5)} 0;
    opacity: ${t?1:.6};
  `)),Je=s.ZP.div((({theme:e})=>s.iv`
    margin-left: ${e.size(2)};
  `)),Ve=e=>{const{active:t,onChange:i}=e,r=Q(),{focus:o,setUI:a}=ee(),[s,c]=(0,h.useState)("/"),[l,d]=(0,h.useState)([]);(0,h.useEffect)((()=>{t&&(r("ArrowUp",(()=>a("focus",o-1))),r("ArrowDown",(()=>a("focus",o+1))),r("ArrowRight",(()=>{c(He.resolvePath(s+"/"+l[o])),a("focus",0)})),r("ArrowLeft",(()=>{c(He.resolvePath(s+"/..")),a("focus",0)})),r("ButtonA",(()=>i(s+"/"+l[o]))))}),[r]),(0,h.useEffect)((()=>{const e=He.resolvePath(s),t=He.listDir(e);d(t)}),[s]);const u=(0,h.useMemo)((()=>l.map(((e,t)=>{const{isFile:i,isExe:r}=(e=>({isFile:e.includes("."),isExe:e.includes(".exe")}))(e);return(0,n.jsxs)(qe,Object.assign({active:o===t},{children:[(0,n.jsx)(Y,{type:i?"file":"folder"}),(0,n.jsx)(Je,{children:e})]}),e+t)}))),[l,o]);return(0,n.jsxs)(Ne,{children:[(0,n.jsx)(Ye,{children:s}),(0,n.jsx)(Xe,{children:u})]})};var Ke=function(e,t,i,n){return new(i||(i=Promise))((function(r,o){function a(e){try{c(n.next(e))}catch(e){o(e)}}function s(e){try{c(n.throw(e))}catch(e){o(e)}}function c(e){var t;e.done?r(e.value):(t=e.value,t instanceof i?t:new i((function(e){e(t)}))).then(a,s)}c((n=n.apply(e,t||[])).next())}))};const Qe=e=>Ke(void 0,void 0,void 0,(function*(){const t=e.split(" ").join("+");return(yield He.fetchHTML(`http://www.bing.com/images/search?q=${t}`)).replace(/&quot;/g,'"').match(/"murl":".*?"/gm).join(",").match(/"https:\/\/.*?"/gm).map((e=>e.replace(/\"/g,"")))})),et=s.ZP.div((({theme:e})=>s.iv`
    width: ${e.size(200)};
    ...
    display: flex;
    justify-content: center;
  `)),tt=s.ZP.img((({theme:e})=>s.iv`
    max-width: 100%;
    max-height: 100%;
    border-radius: ${e.radius.large};
    box-shadow: ${e.shadow.high};
  `));const it=e=>{const{active:t,value:i,onChange:r}=e,o=Q(),{option:a,setUI:s}=ee(),[c,l]=(0,h.useState)(""),[d,u]=(0,h.useState)([]),[g,f]=(0,h.useState)("");return(0,h.useEffect)((()=>{t&&(o("ArrowLeft",(()=>s("option",a-1))),o("ArrowRight",(()=>{a<d.length&&s("option",a+1)})))}),[o]),(0,h.useEffect)((()=>{var e,n,r,o;t&&i.length>=3&&i!==c&&(e=void 0,n=void 0,r=void 0,o=function*(){const e=yield(t=i,Ke(void 0,void 0,void 0,(function*(){const e=`${t.toLowerCase()}`;return yield Qe(e)})));var t;u(e),l(i)},new(r||(r=Promise))((function(t,i){function a(e){try{c(o.next(e))}catch(e){i(e)}}function s(e){try{c(o.throw(e))}catch(e){i(e)}}function c(e){var i;e.done?t(e.value):(i=e.value,i instanceof r?i:new r((function(e){e(i)}))).then(a,s)}c((o=o.apply(e,n||[])).next())}))).catch(console.error)}),[t,i]),(0,h.useEffect)((()=>{r&&r(d[a]),ve(d[a]).then(f)}),[a,d.length]),(0,n.jsx)(et,{children:(0,n.jsx)(tt,{src:g})})},nt=s.ZP.input((({theme:e})=>s.iv`
    width: 100%;
    ...
    text-transform: capitalize;
  `)),rt=e=>{const{value:t,onChange:i}=e;return(0,n.jsx)(nt,{autoFocus:!0,value:t,onChange:e=>i(e.target.value)})},ot=s.ZP.div((()=>s.iv``)),at=s.ZP.div((({theme:e})=>s.iv`
    width: 100%;
    height: 100%;
  ...
  `)),st=s.ZP.div((()=>s.iv`
    ...
    transition: all 0.1s;
  `)),ct=s.ZP.h3((({theme:e})=>s.iv`
    font-size: ${e.fontSize.h3};
    font-weight: bold;
  `)),lt=e=>{const{type:t,active:i,title:r}=e;return(0,n.jsx)(ge,Object.assign({check:i},{children:(0,n.jsx)(ot,{children:(0,n.jsx)(st,{children:(0,n.jsxs)(at,{children:[(0,n.jsx)(ct,{children:r}),(0,n.jsx)(ge,{check:"text"===t,true:(0,n.jsx)(rt,Object.assign({},e))}),(0,n.jsx)(ge,{check:"img"===t,true:(0,n.jsx)(it,Object.assign({},e))}),(0,n.jsx)(ge,{check:"file"===t,true:(0,n.jsx)(Ve,Object.assign({},e))}),(0,n.jsx)(ge,{check:"color"===t,true:(0,n.jsx)(_e,Object.assign({},e))})]})})})}))},dt=s.ZP.div((({theme:e,active:t})=>s.iv`
    width: 75%;
    margin: 0 auto;
    padding: ${e.size(4)};
    ...
    `}
  `)),ht=s.ZP.div((({theme:e})=>s.iv`
    display: flex;
    align-items: center;
    gap: ${e.size(4)};
  `)),ut=s.ZP.div((({theme:e})=>s.iv`
    font-size: ${e.fontSize.h4};
    font-weight: bold;
  `)),gt=s.ZP.div((()=>s.iv`
    transition: 0.3s;
  ...
  `)),mt=e=>{const{active:t,title:i,value:r,children:o}=e;return(0,n.jsxs)(dt,Object.assign({active:t},{children:[(0,n.jsxs)(ht,{children:[(0,n.jsx)(ut,{children:i}),(0,n.jsx)(gt,{children:null==r?void 0:r.substring(0,60)}),(0,n.jsx)(Y,{type:"edit",size:6})]}),(0,n.jsx)(ft,{children:o})]}))},pt=s.ZP.div((()=>s.iv`
    width: 100%;
    height: 100%;
  `)),xt=s.ZP.h2((({theme:e})=>s.iv`
    width: fit-content;
    margin: 0 auto;
    text-align: center;
    font-size: ${e.fontSize.h2};
