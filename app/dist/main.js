...
`),xe=me,ve=fe,be=pe,je=c.ZP.div((()=>c.iv`
    position: fixed;
    top: 0;
    left: 0;
    width: 100%;
  ...
  `)),_e=c.ZP.div((()=>c.iv`
    ...
    display: flex;
    overflow: hidden;
  `)),He=c.ZP.img((({theme:e,focus:t})=>c.iv`
    height: 100%;
    width: ${e.size(50)};
    max-width: ${e.size(50)};
  ...
  `)),Ne=e=>{const{gameList:t,gameIndex:i,onChangeGame:r,onStartGame:o}=e,a=v(),s=(0,u.useMemo)((()=>t[i]),[i,t]);return(0,u.useEffect)((()=>{a("ArrowLeft",(()=>r(i-1))),a("ArrowRight",(()=>r(i+1))),a("ButtonStart",(()=>o(i)))}),[a]),(0,n.jsxs)(Ie,{children:[(0,n.jsxs)(Me,{children:[(0,n.jsx)(Ge,{src:null==s?void 0:s.cover}),(0,n.jsxs)(Re,{children:[(0,n.jsxs)(Fe,{children:[(0,n.jsx)(We,{children:null==s?void 0:s.name}),(0,n.jsx)(Te,{children:null==s?void 0:s.publisher})]}),(0,n.jsx)(_e,{children:t.map((e=>(0,n.jsx)(He,{className:"cove-item",focus:i,src:e.cover},e.name)))})]})]}),(0,n.jsx)(Ue,{buttons:Ee.GameListBar})]})},Xe=c.ZP.div((()=>c.iv`
      width: 100%;
      height: 100%;
      display: flex;
      align-items: flex-end;
    `)),Ye=c.ZP.div((e=>c.iv`
      height: 100%;
      margin: 0 auto;
      max-width: ${e.theme.size(400)};
      display: grid;
      align-content: flex-start;
      justify-items: center;
      grid-template-columns: repeat(4, 1fr);
      grid-gap: ${e.theme.size(8)};
      padding: 0 ${e.theme.size(16)};
    ...
    `)),qe=c.ZP.div((e=>c.iv`
      ...
      background-image: url(${e.imgSrc});
      background-repeat: no-repeat;
      background-size: 100% 100%;
      font-size: ${e.theme.size(10)};
      transition: 0.2s;
      ${e.imgSrc&&"color: transparent;"}

      :nth-child(${e.focus+1}) {
        border: 2px solid ${e.theme.colors.gray};
      }
    `)),Je=e=>{const{gameList:t,gameIndex:i,onChangeGame:r,onStartGame:o}=e,a=v();return(0,u.useEffect)((()=>{const e=(i+1)%4;a("ArrowLeft",(()=>1!==e&&r(i-1))),a("ArrowRight",(()=>0!==e&&r(i+1))),a("ArrowDown",(()=>r(i+4))),a("ArrowUp",(()=>r(i-4)))}),[a]),(0,n.jsxs)(Xe,{children:[(0,n.jsx)(Ye,{children:t.map((e=>(0,n.jsx)(qe,{imgSrc:e.cover,focus:i},e.name)))}),(0,n.jsx)(Ue,{buttons:Ee.GameListGrid})]})},Ve=c.ZP.div((()=>c.iv`
    width: 100%;
    height: 100%;
    display: flex;
    flex-direction: column;
    ...
    overflow: hidden;
  `)),Ke=()=>{const{focus:e,loading:t,setUI:i}=te(),[r,o]=P(),[a,c]=(0,u.useState)([]),[l,d]=(0,u.useState)("list"),h=v();return(0,u.useEffect)((()=>{h("ButtonX",(()=>d("list"===l?"grid":"list")))}),[h]),(0,u.useEffect)((()=>{const e=w.games.read();i("loading",!0),(e=>ke(void 0,void 0,void 0,(function*(){for(const t of e)try{t.background=yield Ze(t.background),t.cover=yield Ze(t.cover)}catch(e){continue}return e})))(e).then(c).finally((()=>i("loading",!1)))}),[]),(0,u.useEffect)((()=>{var t;const i=null===(t=a[e])||void 0===t?void 0:t.background;o(Object.assign(Object.assign({},r),{imgBg:i}))}),[e,a]),(0,n.jsxs)(Ve,{children:[(0,n.jsx)(s,Object.assign({check:"list"===l},{children:(0,n.jsx)(Ne,{gameList:a,gameIndex:e,onChangeGame:e=>e<a.length&&i("focus",e),onStartGame:()=>{}})})),(0,n.jsx)(s,Object.assign({check:"grid"===l},{children:(0,n.jsx)(Je,{gameList:a,gameIndex:e,onChangeGame:e=>e<a.length&&i("focus",e),onStartGame:()=>{}})})),t&&(0,n.jsx)(ze,{})]})},Qe=c.ZP.div((({theme:e})=>c.iv`
    display: flex;
    flex-wrap: wrap;
    gap: ${e.size(2)};
    width: 100%;
  ...
  `));const mt=e=>{const{active:t,value:i,onChange:r}=e,o=v(),{option:a,setUI:s}=te(),[c,l]=(0,u.useState)(""),[d,h]=(0,u.useState)([]),[g,m]=(0,u.useState)("");return(0,u.useEffect)((()=>{t&&(o("ArrowLeft",(()=>s("option",a-1))),o("ArrowRight",(()=>{a<d.length&&s("option",a+1)})))}),[o]),(0,u.useEffect)((()=>{var e,n,r,o;t&&i.length>=3&&i!==c&&(e=void 0,n=void 0,r=void 0,o=function*(){const e=yield(t=i,dt(void 0,void 0,void 0,(function*(){const e=`${t.toLowerCase()}`;return yield ht(e)})));var t;h(e),l(i)},new(r||(r=Promise))((function(t,i){function a(e){try{c(o.next(e))}catch(e){i(e)}}function s(e){try{c(o.throw(e))}catch(e){i(e)}}function c(e){var i;e.done?t(e.value):(i=e.value,i instanceof r?i:new r((function(e){e(i)}))).then(a,s)}c((o=o.apply(e,n||[])).next())}))).catch(console.error)}),[t,i]),(0,u.useEffect)((()=>{r&&r(d[a]),Ae(d[a]).then(m)}),[a,d.length]),(0,n.jsx)(ut,{children:(0,n.jsx)(gt,{src:g})})},ft=c.ZP.input((({theme:e})=>c.iv`
    ...
    text-transform: capitalize;
  `)),pt=e=>{const{value:t,onChange:i}=e;return(0,n.jsx)(ft,{autoFocus:!0,value:t,onChange:e=>i(e.target.value)})},xt=c.ZP.div((()=>c.iv``)),vt=c.ZP.div((({theme:e})=>c.iv`
    width: 100%;
    height: 100%;
